...
void print_usage(char *prog) {
  ...
  printf("  -a <arch>\n");
  printf(
      "     : disassemble as specified instruction architecture (not for pe "
      "and elf files)\n");
  ...
  printf(
      "     : disassemble with a specific instruction set (not for pe and elf "
      "files)\n");
  ...
  printf("  -o : best offset search (only for raw binaries)\n");
  ...
  printf("  -h : help\n");
  printf(
      "\nConfiguration used in paper 'Compiler-Agnostic Function Detection in "
      "Binaries':\n");
